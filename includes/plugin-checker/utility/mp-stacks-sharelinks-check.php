<?php
/**
 * This file contains a function which checks if the MP Stacks + ShareLinks plugin is installed.
 *
 * @since 1.0.0
 *
 * @package    MP Core + ShareLinks
...
add_filter( 'mp_core_check_plugins', 'mp_stacks_sharelinks_plugin_check' );